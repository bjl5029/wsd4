...
export default {
  ...
  created() {
    this.popularMoviesUrl = getURL4PopularMovies(1);
    this.newReleasesUrl = getURL4ReleaseMovies(1);
    this.actionMoviesUrl = getURL4GenreMovies('28', 1);
    fetchFeaturedMovie().then((movie) => {
