          ...
          <div :class="['card', { hidden: !isLoginVisible }]" id="login">
            <form @submit.prevent="handleLogin">
              ...
              <div class="kakao-login-container">
                <button type="button" @click="handleKakaoLogin" class="kakao-login-btn">
...
const handleKakaoLogin = () => {
  ...
  window.Kakao.Auth.login({
    scope: 'profile_nickname profile_image', // 필요한 동의 항목만 지정
    success: (authObj) => {
      window.Kakao.API.request({
        ...
        success: (res) => {
          console.log('카카오 사용자 정보:', {
            id: res.id,
            nickname: res.properties?.nickname || '카카오 사용자',
